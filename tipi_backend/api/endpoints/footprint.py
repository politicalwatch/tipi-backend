...
@ns.route("/range-by-all-topics")
class FootprintRangeByAllTopics(Resource):
    def get(self):
...
class FootprintByParliamentaryGroup(Resource):
    def get(self):
        ...
        try:
            ...
            log.error(e)
            return {
                "Error": f"No footprint by parliamentary group {args['parliamentarygroup']} found."
            }, 404
